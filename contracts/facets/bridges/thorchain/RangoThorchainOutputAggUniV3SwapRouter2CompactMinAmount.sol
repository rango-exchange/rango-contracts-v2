...
import "../../../interfaces/IUniswapV3SwapRouter2.sol";
...
contract RangoThorchainOutputAggUniV3SwapRouter2 is ReentrancyGuard {
    ...
    IUniswapV3SwapRouter2 public dexRouter;
    ...
    constructor(address _weth, address _dexRouter, uint24 _v3PoolFee) {
        ...
        dexRouter = IUniswapV3SwapRouter2(_dexRouter);
    ...
    function swapOut(address token, address to, uint256 amountOutMinRaw) public payable nonReentrant {
        ...
        dexRouter.exactInputSingle(
            IUniswapV3SwapRouter2.ExactInputSingleParams(
            {
